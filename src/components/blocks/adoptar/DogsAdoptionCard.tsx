...
export default function DogsAdoptionCard({
  ...
  return (
    ...
    >
      ...
      <Paw className="absolute bottom-0 right-2 z-10 w-8 h-8 text-white opacity-0 scale-75 transition-all duration-300 group-hover:opacity-80 group-hover:scale-100 group-hover:rotate-12" />
    </div>
  );
}
